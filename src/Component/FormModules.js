    ...
    const Formname = () => {
        return (
            <section className='App-formname'>
                <section className='blc-formname'>
                    <section className='equal-formname entete-formname'>
                        <h1>Creer une formation</h1>
                        <span onClick={handleshowformname}>Annuler</span>
                    </section>
    ...
    return (
        <div className='entete-formation'>
            <div className='fa-entete-formation'>
                ...
                {showformname && <Formname />}
                <div>
                    <span onClick={handleshowformname} className='span'><img src={plus} />Creer une formation</span>
                    <i><img src={start} /></i>
