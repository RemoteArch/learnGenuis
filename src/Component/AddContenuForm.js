...
const AddContenueForm = () => {
    ...
    const handleAddModule = () => {
        if (newModuleTitle.trim() !== '') {
            setModules([...modules, { description: newModuleDescription, duree: newModuleDuration, difficulte: newModuleDifficulty, title: newModuleTitle, id: Date.now(), pages: [] }]);
            setNewModuleTitle('');
            ...
            console.log(newModuleDifficulty);
            console.log(newModuleDuration);
